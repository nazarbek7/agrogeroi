...
const getTypeIcon = (type: NotificationType) => {
  switch (type) {
    case NotificationType.ORDER_UPDATE:
      return <FaShoppingCart className="text-green-700" />;
...
const getPriorityBadge = (priority: NotificationPriority) => {
  const priorityStyles = {
    ...
    [NotificationPriority.NORMAL]: 'bg-blue-100 text-green-700 border-blue-300',
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-start justify-between mb-2">
            <div className="flex items-center space-x-2 flex-1">
              ...
              {!notification.isRead && (
                <div className="w-2 h-2 bg-green-700 rounded-full flex-shrink-0" aria-label="Unread notification" />
              )}
            </div>
            ...
            <div className="flex items-center space-x-2">
              {!notification.isRead && (
                <button
                  ...
                  className="inline-flex items-center px-2 py-1 text-xs font-medium text-green-700 bg-blue-100 rounded hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 transition-colors"
