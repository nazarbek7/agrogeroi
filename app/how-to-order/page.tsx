...
export const metadata = { title: "Как сделать заказ — Agrogeroi" };
...
const steps = [
  {
    ...
    desc: "Просмотрите каталог на сайте. Используйте фильтры по категориям — гортензии, хвойные, розы, плодовые, лианы и др. Нажмите «В корзину» для понравившихся товаров.",
  },
  {
    num: 2,
    icon: "🛒",
