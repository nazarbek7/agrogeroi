export const metadata = { title: "Условия использования — Агрогерои" };
        ...
        {[
          {
            ...
            text: "Используя сайт agrogeroi.com, вы соглашаетесь с настоящими условиями. Сайт принадлежит и управляется компанией Агрогерои (Кыргызстан).",
          },
          {
          ...
          },
          {
            ...
            text: "Все материалы сайта (тексты, фотографии, логотипы) принадлежат Агрогерои. Использование без разрешения запрещено.",
          },
          {
